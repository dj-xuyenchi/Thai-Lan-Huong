...
namespace dj_actionlayer.Business.Email
{
    public class TemplateEmail
    {
        ...
        {
            return "🌱 Xin chào mình nhận được yêu cầu đăng ký tài khoản DJ - Coding để hoàn thành đăng ký vui lòng nhập mã xác nhận dưới đây. " + data + ". Nếu bạn không có yêu cầu này vui lòng bỏ qua.";
        }
